...
-- Trigger for capturing changes to specific columns
CREATE TRIGGER trigger_record_user_info
BEFORE UPDATE ON transactions
FOR EACH ROW EXECUTE FUNCTION record_changed_columns();

-- Example update to trigger the change
update transactions set amount = amount + 500 where transaction_id = '8331dd37-d665-4fce-a951-6863ba099609'